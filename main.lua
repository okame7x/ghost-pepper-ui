		...
		function tab:AddSection(sectionName)
			...
			function section:AddAssetFilter(config)
				...
				for index, item in ipairs(items) do
					...
					name.Position, name.Size = UDim2.fromOffset(84, 0), UDim2.new(1, -194, 1, 0)
